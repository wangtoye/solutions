...
public class RedisCallbackCacheWriter implements RedisCacheWriter {
     ...
     */
    RedisCallbackCacheWriter(RedisConnectionFactory connectionFactory, RedisTemplate redisTemplate) {
     ...
     *                          to disable locking.
     */
    RedisCallbackCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime,
